...
You can view conflicted revisions respectively to manually resolve the conflicts, which would prevent losing your edits.

![Conflicted note](https://github.com/inkdropapp/version-history-mobile/blob/master/images/v4.2.0-better-conflict-resolution_1.png?raw=true)

![Resolution menu](https://github.com/inkdropapp/version-history-mobile/blob/master/images/v4.2.0-better-conflict-resolution_2.png?raw=true)

![Reviewing a conflict revision](https://github.com/inkdropapp/version-history-mobile/blob/master/images/v4.2.0-better-conflict-resolution_3.png?raw=true)

You can view a conflicted revision as patch, which would be handy to manually resolve the conflict.

### Improvements

* Plugins are updated. Math plugin now supports `{equation}` syntax! ([Learn more](https://my.inkdrop.app/plugins/math))

### Bug fixes

* The initial sync not working for some old users (Thanks [Ben and Bertrand](https://forum.inkdrop.app/t/initial-sync-problem-with-android-4-1-0/2514))
* Images cannot be inserted on iOS (Thanks [Ryan, phi, and Tanin](https://forum.inkdrop.app/t/unable-to-upload-photo-on-ios/2372))
...
* Data sync and loading image speeds have been improved ([Thanks Marco](https://forum.inkdrop.app/t/2-images-1920x1080-not-loading-on-android/1898))
* Use system color scheme for syntax theme by default
* Fixed TOC anchors not working (Thanks [T_Crain](https://forum.inkdrop.app/t/toc-links-not-working-on-mobile/2359))
